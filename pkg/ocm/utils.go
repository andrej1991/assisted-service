...
// 4xx responses use InfraError with the same status code so semantics match the upstream call
// (for example 404 Not Found versus 401 Unauthorized). 5xx responses use ApiError with the same code.
